...
```
# --model-name-or-path can be a HF hub id or a local dir.
# The original CS336 example used "/home/shared/Meta-Llama-3-70B-Instruct"
# from the Stanford cluster; outside that env, pass a path you actually have.
python scripts/evaluate_safety.py \
    --input-path <path_to_predictions.jsonl> \
    --model-name-or-path meta-llama/Meta-Llama-3-70B-Instruct \
    --num-gpus 2 \
