...
@pytest.fixture
def model_id():
    # Original CS336 a5-alignment cluster path. Override with env var when
    # running outside Stanford infra, e.g.:
    #   ALIGNMENT_MODEL_ID=Qwen/Qwen2.5-Math-1.5B uv run pytest tests/alignment
    # The tiny-gpt2 bundled under tests/alignment/fixtures/tiny-gpt2/ is
    # another valid value for offline / quick tests.
